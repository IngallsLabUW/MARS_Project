...
- Sort within confidence levels according to MS2 match?
- Order of parameter matching for Confidence level 1. mz, then z & column, then rt, then ms2.
...
- When should common contaminants be flagged? At the beginning or post-standards ID? Is that list updatable (is there an online place, or maybe it's just from that paper)?
---
