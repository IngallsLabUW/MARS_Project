...
# write.csv(bet_data_by_mz, file = "~/bet_data_by_mz.csv", row.names = FALSE)
# write.csv(bet_data_by_name, file = "~/bet_data_by_name.csv", row.names = FALSE)
# write.csv(bet_MSMS_data, file = "~/bet_MSMS_data.csv", row.names = FALSE)
